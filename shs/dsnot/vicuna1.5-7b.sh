...
CUDA_VISIBLE_DEVICES='4,5' /h3cstore_ns/jcxie/condaenv/bin/python /h3cstore_ns/jcxie/LISA/DSnoT-main/main.py \
    --prune_method DSnoT \
    --model /h3cstore_ns/jcxie/hf_weights/vicuna-7b-v1.5 \
    --initial_method wanda \
    --sparsity_ratio 0.7  &

CUDA_VISIBLE_DEVICES='6,7' /h3cstore_ns/jcxie/condaenv/bin/python /h3cstore_ns/jcxie/LISA/DSnoT-main/main.py \
    --prune_method DSnoT \
    --model /h3cstore_ns/jcxie/hf_weights/vicuna-7b-v1.5 \
    --initial_method wanda \
    --sparsity_ratio 0.8  &
