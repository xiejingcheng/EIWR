...
CUDA_VISIBLE_DEVICES='5,6' /h3cstore_ns/jcxie/condaenv/bin/python /h3cstore_ns/jcxie/LISA/nips2024/main.py \
    --prune_method sparsegpt_dual_5 \
    --model /h3cstore_ns/jcxie/hf_weights/Qwen2.5-3b \
    --dual_theld 0.03 \
    --sparsity_ratio 0.8  &

CUDA_VISIBLE_DEVICES='7,8' /h3cstore_ns/jcxie/condaenv/bin/python /h3cstore_ns/jcxie/LISA/nips2024/main.py \
    --prune_method sparsegpt_dual_5 \
    --model /h3cstore_ns/jcxie/hf_weights/Qwen2.5-3b \
    --dual_theld 0.03 \
    --sparsity_ratio 0.9  &
